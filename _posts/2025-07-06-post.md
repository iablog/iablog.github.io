...
- [1 - Configurações Iniciais](#1---configurações-iniciais)
  ...
  - [1.2 - Obtendo uma Chave para a API](#12---obtendo-uma-chave-para-a-api)
  - [1.3 - Armazenando a Chave da API](#13---armazenando-a-chave-da-api)
  - [1.4 - Carregando a Chave em Python](#14---carregando-a-chave-em-python)
- [2 - Verificando modelos disponíveis](#2---verificando-modelos-disponíveis)
- [3 - Usando apenas Texto](#3---usando-apenas-texto)
  - [3.1 - Gerando resumo](#31---gerando-resumo)
  - [3.2 - Criando receitas](#32---criando-receitas)
- [4 - Fornecendo Imagens](#4---fornecendo-imagens)
- [5 - Utilizando para Conversar (Chat)](#5---utilizando-para-conversar-chat)
