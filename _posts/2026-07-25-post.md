...
Nos dois gráficos superiores (na 1a linha), vemos os resultados da métrica 1. Em cada um dos gráficos, variei: *quantidade de figurinhas* (gráfico superior, à esquerda), e a *proporção de figurinhas recebidas* (à direita). 
...
- O cenário em que todos são *egoístas* só consegue ser melhor **nos casos em que os colecionadores (todos) compram muitas figurinhas** a mais (a partir de 105% do álbum). 
...
Analisando agora, de forma geral, podemos concluir que, quando todos fazem trocas generosas, **mais colecionadores completam o álbum e o completam em menos tempo**. 

Em um cenário em que todos os colecionadores são *egoístas* só tem alguma vantagem se **todos gastarem mais com figurinhas** (o que não é lá muito bom para o "bolso").
